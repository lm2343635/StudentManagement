...
<html>
	...
	<body>
	 ...
	 <form action="modifyTeacherInfoHandle.jsp" method="post"  >
    <table width="914"  border="0">
	   ...
	   <tr>
	     ...
	     <td width="300" align="center" bgcolor="#D9FFFF"><input type="text" name="tname" ></td>
	   ...
	   <tr>
	     ...
	     <td align="center" bgcolor="#D9FFFF">
		     <input type="radio" name="tsex" value="male" >男
	         <input type="radio" name="tsex" value="female">女
	     </td>
	   ...
	   <tr>
	     ...
	     <td align="center" bgcolor="#D9FFFF">电话</td>
	     <td colspan="300" align="center" bgcolor="#D9FFFF"><input type="text" name="telphone" ></td>
      </tr>
	   <tr>
	     <td height="40" align="center" bgcolor="#D9FFFF">邮箱</td>
	     <td align="center" bgcolor="#D9FFFF"><input type="text" name="email" ></td>
	     <td align="center" bgcolor="#D9FFFF">院系</td>
	     <td colspan="300" align="center" bgcolor="#D9FFFF">
	     	<select name="college">
	 		<option value="null" selected></option>
			<%
			ResultSet rs=connectDatabase.exeQuery("select coname from college");	
			while(rs.next())
			{
			%>
			<option value="<%=rs.getString("coname")%>" ><%=rs.getString("coname")%></option>
			<%
			}
			%>
         	</select>
	   ...
	   <tr>
	     <td height="40" align="center" bgcolor="#D9FFFF">身份证号</td>
	     <td align="center" bgcolor="#D9FFFF"><input type="text" name="IDcard" ></td>
	     <td align="center" bgcolor="#D9FFFF">家庭住址</td>
	     <td colspan="300" align="center" bgcolor="#D9FFFF"><input type="text" name="homeAddress" ></td>
      </tr>
