		...
		<table width="750"  border="0">
			   <tr>
				     <td height="40" colspan="5" align="center" bgcolor="#0000FF">
				     	<myfont><%=coname%>-选择专业</myfont>
				     	<button type="button"  onClick="window.location.href='manageStudent.jsp'">返回</button>
				     </td>
			  </tr> 
			  <tr>
		...
		{%>
			  <tr>
				     ...
				     <td width="600" align="center" bgcolor="#D9FFFF">
				     	<a href="manageStudentDe.jsp?dno=<%=rs.getString("dno")%>&cono=<%=cono %>"><%=rs.getString("dname")%></a>
				     </td>
			  </tr>
		<%
		}
